...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../covid/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="../covid/assets/img/favicon.png">
  <title>
  ...
  <!-- Nucleo Icons -->
  <link href="../covid/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="../covid/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="../covid/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="../covid/assets/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />
</head>
...
$sql="insert into signin(name,email,pass)values('$name','$e','$p')";
...
?>
  ...
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../covid/assets/img/curved-images/img15.jpeg');">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome!</h1>
            <p class="text-lead text-white" style="padding: top 7px;">SIGN-IN TO MOVE FORWARD.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form   action="#" method="post">
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" name="pass" >
                </div>
                ...
                <p class="text-center text-danger">    <?php echo $result;?></p>
                <div class="text-center">
                <a href="sign-in.php"><button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="sub" >Sign up</button></a> 
                </div>
  ...
  <!--   Core JS Files   -->
  <script src="../covid/assets/js/core/popper.min.js"></script>
  <script src="../covid/assets/js/core/bootstrap.min.js"></script>
  <script src="../covid/assets/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="../covid/assets/js/plugins/smooth-scrollbar.min.js"></script>
  <script>
  ...
  <script src="../covid/assets/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
</body>
